  ...
  return (
    <footer className="border-t border-brand-light/30 bg-white/90">
      <div className="mx-auto flex w-full max-w-6xl flex-col gap-6 px-6 py-10 text-sm text-subtle sm:flex-row sm:items-center sm:justify-between">
        ...
        <nav aria-label="Footer menu" className="flex flex-wrap items-center gap-4">
          <Link
            href="#privacy"
            className="transition hover:text-brand-dark focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-brand-dark"
          >
            Privacy
          </Link>
          <Link
